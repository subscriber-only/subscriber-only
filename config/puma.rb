...
# value specified for Puma. Default is set to 5 threads for minimum and maximum;
# this matches the default thread size of Active Record.
...
# This will cause Puma to create a bind automatically for any activated socket.
# Discards any binds that's not socket activated.
